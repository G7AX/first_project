    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <?php if (isset($_SESSION['failed_message'])) : ?>
            <div class="alert alert-danger">
                <?php echo $_SESSION['failed_message'];
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $user['status'] ?> mr-3">
                                    <a href="page_profile.php?id=<?php echo $user['id'] ?>"><span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo "img/userpictures/" . $user['userpicture'] ?>'); background-size: cover;"></span></a>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false" style="text-transform: capitalize;">
                                        <?php echo $user['name'] ?>
                                        <?php if (!empty($_SESSION)) : ?>
                                            <?php if ($user['id'] == $_SESSION['user']['id'] or $_SESSION['user']['role'] == 'admin') : ?>
                                    ...
                                    <?php if (!empty($_SESSION)) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <span style="text-transform: capitalize;" class=" text-truncate text-truncate-xl"><?php echo $user['job'] ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="<?php echo $user['vkontakte'] ?>" target="_blank" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="<?php echo $user['telegram'] ?>;" target="_blank" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="<?php echo $user['instagram'] ?>" target="_blank" class="mr-2 fs-xxl" style="color:#E1306C">
