                    ...
                    <div class="row no-gutters row-grid">
                        <div class="col-12">
                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                <img src="<?php echo "img/userpictures/" . $user['userpicture'] ?>" class="rounded-circle shadow-2 img-thumbnail" alt="userpicture" style="object-fit: cover; object-position: center; width: 120px; height: 120px;">
